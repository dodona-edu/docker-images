...
RUN mkdir -p /usr/share/man/man1mkdir -p /usr/share/man/man1 \
 ...
 && pip install --no-cache-dir --upgrade jsonschema==4.4.0 psutil==5.9.0 mako==1.2.2 pydantic==1.9.0 typing_inspect==0.7.1 pylint==2.6.0 lark==0.10.1 pyyaml==6.0 Pygments==2.11.2 python-i18n==0.3.9 \
